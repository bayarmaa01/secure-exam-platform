...
async function ensureTablesExist(client: PoolClient) {
  ...
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS exams (
      ...
      description TEXT,
      type VARCHAR(20) DEFAULT 'mcq' CHECK (type IN ('mcq', 'writing', 'coding', 'mixed', 'ai_proctored')),
    ...
    `CREATE TABLE IF NOT EXISTS questions (
      ...
      options JSONB,
      correct_answer TEXT,
      type VARCHAR(20) DEFAULT 'mcq' CHECK (type IN ('mcq', 'short_answer', 'long_answer', 'coding')),
